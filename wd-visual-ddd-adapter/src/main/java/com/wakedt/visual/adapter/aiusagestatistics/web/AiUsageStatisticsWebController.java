package com.wakedt.visual.adapter.aiusagestatistics.web;
 ...
 */
@RestController
@RequestMapping("/web/ai-usage-statistics")
@Api(value = "/web/ai-usage-statistics", tags = "AI 使用统计-B端")
public class AiUsageStatisticsWebController {
