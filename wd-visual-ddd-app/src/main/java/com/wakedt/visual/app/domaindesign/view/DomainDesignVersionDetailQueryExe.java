 ...
 */
@Component
public class DomainDesignVersionDetailQueryExe {
    ...
    public ResultDTO<DomainDesignVersionDTO> execute(DomainDesignVersionDetailQuery query) {
        DomainDesignVersionDO domaindesignversionDO = Optional.ofNullable(domaindesignversionMapper.domainDesignVersionDetailQuery(query))
