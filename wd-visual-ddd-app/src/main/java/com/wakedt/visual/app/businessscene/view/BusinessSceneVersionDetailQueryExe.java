 ...
 */
@Component
public class BusinessSceneVersionDetailQueryExe {
    ...
    public ResultDTO<BusinessSceneVersionDTO> execute(BusinessSceneVersionDetailQuery query) {
        BusinessSceneVersionDO businesssceneversionDO = Optional.ofNullable(businessSceneVersionMapper.businessSceneVersionDetailQuery(query))
